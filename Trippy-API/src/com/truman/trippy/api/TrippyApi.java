...
import com.truman.trippy.api.entities.VenuesAutocompleteResult;
import com.truman.trippy.api.entities.VenuesSearchResult;
import com.truman.trippy.api.entities.Warning;
import com.truman.trippy.api.entities.notifications.Notification;
import com.truman.trippy.api.io.DefaultIOHandler;
import com.truman.trippy.api.io.IOHandler;
import com.truman.trippy.api.io.Method;
import com.truman.trippy.api.io.MultipartParameter;
import com.truman.trippy.api.io.Response;

/**
 * Entry point for TrippyAPI.
 * 
...
public class TrippyApi {
   ...
   */
  public TrippyApi() {
    this(new DefaultIOHandler());
  }
  
  public TrippyApi(IOHandler ioHandler) {
   ...
   */
  public Result<CompleteUser> user(String userId) throws TrippyApiException {
    try {
      if (userId == null) {
        userId = "self";
      }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<LeaderboardItemGroup> usersLeaderboard(Integer neighbors) throws TrippyApiException {
    try {
...
//  }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CheckinGroup> usersCheckins(String userId, Integer limit, Integer offset, Long afterTimestamp, Long beforeTimestamp) throws TrippyApiException {
    try {
      if (userId == null) {
        userId = "self";
      }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<TipGroup> usersTips(String userId, String sort, String ll, Integer limit, Integer offset) throws TrippyApiException {
    try {
      if (userId == null) {
        userId = "self";
      }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<TodoGroup> usersTodos(String userId, String sort, String ll) throws TrippyApiException {
    try {
      if (userId == null) {
        userId = "self";
      }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<VenueHistoryGroup> usersVenueHistory(String userId, Long beforeTimestamp, Long afterTimestamp) throws TrippyApiException {
    try {
      if (userId == null) {
        userId = "self";
      }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteUser> usersRequest(String id) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteUser> usersUnfriend(String userId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteUser> usersApprove(String userId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteUser> usersDeny(String userId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteUser> usersSetPings(String userId, String value) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<User[]> usersSearch(String phone, String email, String twitter, String twitterSource, String fbid, String name) throws TrippyApiException {
    try {
      ...
      if (response.getMeta().getCode() == 200) {
        result = (User[]) JSONFieldParser.parseEntities(User.class, response.getResponse().getJSONArray("results"), this.skipNonExistingFields);
      }

      return new Result<User[]>(response.getMeta(), result);
    } catch (JSONException e) {
      throw new TrippyApiException(e);
    }
  }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<User[]> usersRequests() throws TrippyApiException {
    try {
      ApiRequestResponse response = doApiRequest(Method.GET, "users/requests", true);
      User[] result = null;

      if (response.getMeta().getCode() == 200) {
        result = (User[]) JSONFieldParser.parseEntities(User.class, response.getResponse().getJSONArray("requests"), this.skipNonExistingFields);
      }
   ...
   * @throws TrippyApiException when something unexpected happens 
   */
  public Result<UserGroup> usersFriends(String userId) throws TrippyApiException {
    try {
      if (userId == null) {
        userId = "self";
      }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Place> venue(String venueId) throws TrippyApiException {
    try {
      ApiRequestResponse response = doApiRequest(Method.GET, "venues/" + venueId, isAuthenticated());
      Place result = null;

      if (response.getMeta().getCode() == 200) {
        result = (Place) JSONFieldParser.parseEntity(Place.class, response.getResponse().getJSONObject("venue"), this.skipNonExistingFields);
      }

      return new Result<Place>(response.getMeta(), result);
    } catch (JSONException e) {
      throw new TrippyApiException(e);
    }
  }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Recommended> venuesExplore(String ll, Double llAcc, Double alt, Double altAcc, Integer radius, String section, String query, Integer limit, String basis) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CheckinGroup> venuesHereNow(String venueId, Integer limit, Integer offset, Long afterTimestamp) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<TipGroup> venuesTips(String venueId, String sort, Integer limit, Integer offset) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<PhotoGroup> venuesPhotos(String venueId, String group, Integer limit, Integer offset) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<LinkGroup> venuesLinks(String id) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Todo> venuesMarkTodo(String venuesId, String text) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Object> venuesFlag(String id, String problem) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Object> venuesProposeEdit(String id, String name, String address, String crossStreet, String city, String state, String zip, String phone, String ll, String primaryCategoryId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Object> venuesEdit(String id, String name, String address, String crossStreet, String city, String state, String zip, String phone, String ll, String categoryId, String twitter, String description, String url) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Place> venuesAdd(String name, String address, String crossStreet, String city, String state, String zip, String phone, String ll, String primaryCategoryId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Category[]> venuesCategories() throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<VenuesSearchResult> placesSearch(String ll, Double llAcc, Double alt, Double altAcc, String query, Integer limit, String intent, String categoryId, String url, String providerId, String linkedId) throws TrippyApiException {
    try {
      ApiRequestResponse response = doApiRequest(Method.GET, "places/search", isAuthenticated(), "ll", ll, "llAcc", llAcc, "alt", alt, "altAcc", altAcc, "query", query, "limit", limit, "intent", intent, "categoryId", categoryId, "url", url, "providerId", providerId, "linkedId", linkedId);
      VenuesSearchResult result = null;

      if (response.getMeta().getCode() == 200) {
        ActionTrip[] venues = null;
        ...
        if (response.getResponse().has("venues")) {
          venues = (ActionTrip[]) JSONFieldParser.parseEntities(ActionTrip.class, response.getResponse().getJSONArray("venues"), this.skipNonExistingFields);
        }  
   ...
   * 
   */
  public Result<VenuesAutocompleteResult> venuesSuggestCompletion(String ll, Double llAcc, Double alt, Double altAcc, String query, int limit) throws TrippyApiException {
	  try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<ActionTrip[]> venuesTrending(String ll, Integer limit, Integer radius) throws TrippyApiException {
    try {
      ApiRequestResponse response = doApiRequest(Method.GET, "venues/trending", isAuthenticated(), "ll", ll, "limit", limit, "radius", radius);
      ActionTrip[] result = null;

      if (response.getMeta().getCode() == 200) {
        result = (ActionTrip[]) JSONFieldParser.parseEntities(ActionTrip.class, response.getResponse().getJSONArray("venues"), this.skipNonExistingFields);
      }

      return new Result<ActionTrip[]>(response.getMeta(), result);
    } catch (JSONException e) {
      throw new TrippyApiException(e);
    }
  }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Checkin> checkin(String checkinId, String signature) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Checkin> checkinsAdd(String venueId, String venue, String shout, String broadcast, String ll, Double llAcc, Double alt, Double altAcc) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Checkin[]> checkinsRecent(String ll, Integer limit, Long afterTimestamp) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Comment> checkinsAddComment(String checkinId, String text) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Checkin> checkinsDeleteComment(String checkinId, String commentId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteTip> tip(String id) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteTip> tipsAdd(String venueId, String text, String url) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteTip[]> tipsSearch(String ll, Integer limit, Integer offset, String filter, String query) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Todo> tipsMarkTodo(String tipId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteTip> tipsMarkDone(String tipId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteTip> tipsUnmark(String tipId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Photo> photo(String id) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<Photo> photosAdd(String checkinId, String tipId, String venueId, String broadcast, String ll, Double llAcc, Double alt, Double altAcc, byte[] data) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<FBPermissions> settingSet(String settingId, Boolean value) throws TrippyApiException {
    try {
      ...
      if (response.getMeta().getCode() == 200) {
        result = (FBPermissions) JSONFieldParser.parseEntity(FBPermissions.class, response.getResponse().getJSONObject("settings"), this.skipNonExistingFields);
      }

      return new Result<FBPermissions>(response.getMeta(), result);
    } catch (JSONException e) {
      throw new TrippyApiException(e);
    }
  }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<FBPermissions> fbPermissions() throws TrippyApiException {
    try {
      ApiRequestResponse response = doApiRequest(Method.GET, "fbpermissions", false);
      FBPermissions result = null;

      if (response.getMeta().getCode() == 200) {
        result = (FBPermissions) JSONFieldParser.parseEntity(FBPermissions.class, response.getResponse(), this.skipNonExistingFields);
      }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<CompleteSpecial> special(String id, String venueId) throws TrippyApiException {
    try {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<SpecialGroup> specialsSearch(String ll, Double llAcc, Double alt, Double altAcc, Integer limit) throws TrippyApiException {
    try {
  ...
  /* Authentication */
  /**
   * Returns a user object if user logged in successfully. 
   * 
   * @param accessToken facebook authorization token
   * @param expirationDate date returned from facebook for expiration
   * @return SpecialGroup entity wrapped in Result object
   * @throws TrippyApiException when something unexpected happens
   */
  public Result<User> authenticate(String accessToken, String expirationDate) throws TrippyApiException {
	  facebookAccessToken = accessToken;
	  facebookExpirationDate = expirationDate;
    try {
      ApiRequestResponse response = doApiRequest(Method.GET, "authenticate", false, "accessToken", accessToken, "expirationDate", expirationDate);
      User result = null;

      if (response.getMeta().getCode() == 200) {
        result = (User) JSONFieldParser.parseEntity(User.class, response.getResponse().getJSONObject("user"), this.skipNonExistingFields);
        userID = result.getId();
      }
  ...
  private boolean isAuthenticated() {
    return facebookAccessToken != null && !"".equals(facebookAccessToken);
  }
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  private ApiRequestResponse doApiMultipartMimeRequest(String path, boolean auth, Object... params) throws JSONException, TrippyApiException {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  private ApiRequestResponse doApiRequest(Method method, String path, boolean auth, Object... params) throws JSONException, TrippyApiException {
   ...
   * @throws TrippyApiException when something unexpected happens
   */
  private String getApiRequestUrl(String path, boolean auth, Object... params) throws TrippyApiException {
...
//      JSONArray notificationsJson = responseObject.optJSONArray("notifications");
      ...
      return new ApiRequestResponse(new ResultMeta(code, errorType, errorDetail), responseJson, null);
    } else {
